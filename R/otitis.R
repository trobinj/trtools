...
#' }
#'
#' @note Details concerning the source of these data can be found in Mandel et al. (1982). These data are also featured in Rosner (1989). Note that the data are formatted in aggregate form so that the \code{count} variable reflects the number of children with a given combination of values of the other variables. 
#'
#' @source Rosner, B. (1989). Multivariate methods for clustered binary data with more than one level of nexting. \emph{Journal of the American Statistical Association}, \emph{84}, 373-380.
#' 
