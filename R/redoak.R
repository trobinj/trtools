...
#' \describe{
#'    \item{dbh:}{diameter at breast height (in)}
#'    \item{volume:}{tree volume (cubic ft)}
#'    \item{height:}{tree height (ft)}
#' }
#'
#' @note The data are from Gregoire and Valentine (2007). They obtained the data from Beers and Gingrich (1958). 
#' 
#' @source Beers, T. W. & Gingrich, S. F. (1958). Construction of cubic-foot volume tables for red oak in Pennsylvania. \emph{Journal of Forestry}, \emph{56}, 210--214.
#' 
