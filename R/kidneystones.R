...
#' \describe{
#'    \item{size}{kidney stone size (less than 2cm or greater than or equal to 2cm)}
...
#' }
#'
#' @note These data have been used to illustrate Simpson's paradox by comparing percutaneous nephrolithotomy with the open surgical methods (i.e., nephrolithotomy and pyelolithotomy, pyelolithotomy, and ureterolithotomy) grouped into a single treatment condition. The paradox is observed when the methods are compared with and without controlling for stone size. See \url{https://en.wikipedia.org/wiki/Simpson's_paradox}. 
#'
