...
#'
#' @format A data frame of 13 observations and three variables:
#' \describe{
#'    \item{cycles:}{number of menstrual cycles required for pregnancy}
#'    \item{smoker:}{number of smokers}
#'    \item{nonsmoker:}{number of non-smokers}
#' }
#'
#' @note Note that the number of cycles is right-censored. These data were featured in Pawitan (2013) and Weinberg and Gladen (1986). They are a subset of the data collected in a study described by Baird and Wilcox (1985). 
#'
