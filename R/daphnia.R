...
#'
#' These data are from a stratified random sample from three layers of a lake: epilimnion, thermocline, and hypolimnion. The volumes of these layers are 100kL, 200kL, and 400kL respectively, so that the sampling fractions are 1/7, 2/7, and 4/7, respectively. The sampling units are one liter containers of water, and the target variable is daphnia per liter.
#'
