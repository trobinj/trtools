...
#' }
#' 
#' @note See Jeffers (1987) for details about the experimental design and motivation for the study. 
#'
#' @source Jeffers, J. N. R. (1987). Acid rain and tree roots: An analysis of an experiment. In D. J. Hand & B. S. Everitt (Eds.), \emph{The statistical consultant in action} (80-107). Cambridge: Cambridge University Press.
#' 
"acidrain"
