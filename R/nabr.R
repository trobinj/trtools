...
#' }
#'
#' @source OMaul, A., El-Shaarawi, A. H., and F\'{e}rard, J. F. (1991). Application of negative binomial regression models to the analysis of quantal bioassay data. \emph{Environmetrics}, \emph{2}, 253--261. The data are also featured in Maul, A. (1992). Application of generalized linear models to the analysis of toxicity test data. \emph{Environmental Monitoring and Assessment}, \emph{23}, 153--163.
#' 
"nabr"