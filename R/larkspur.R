#' Sample of transects of pale white larkspur.
#'
...
#' }
#'
#' @note Although not stated explicitly in the source, the sample was presumably obtained using simple random sampling.
#'
#' @source Stehman, S. V., & Salzer, D. W. 2000. Estimating density from surveys employing unequal-area belt transects. \emph{Wetlands}, \emph{20}, 512-519.
#'
