...
$$
  \log[\pi_i/(1-\pi_i)] =
  \begin{cases}
    \beta_0 + \beta_3 \log(d_i), & \text{if insecticide is BHC}, \\
    \beta_0 + \beta_1 + (\beta_3 + \beta_4) \log(d_i), & \text{if insecticide is BHC+DDT}, \\
    \beta_0 + \beta_2 + (\beta_3 + \beta_5) \log(d_i), & \text{if insecticide is DDT},
  \end{cases}
$$
